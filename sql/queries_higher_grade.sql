-- QUERIES SCRIPT OPTIMIZATION FOR HIGHER GRADE
...
SELECT
  ...
  m.study_period,
  m.number_of_courses
FROM mv_teacher_courses_per_period m
JOIN employee e ON e.id = m.employment_id
JOIN person p ON p.id = e.person_id
WHERE m.study_period = 'P2'
  AND m.number_of_courses > 5;  
